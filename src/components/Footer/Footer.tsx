...
function Footer() {
  return (
    <footer className="bg-secondary flex flex-col items-center justify-center py-6">
      <div className="grid lg:grid-cols-3 grid-cols-2 lg:w-4/5 w-7/8 gap-x-10 gap-y-10  ">
        <div className=" col-span-2 lg:col-span-1 flex flex-col justify-start items-start">
          <div className="flex items-center justify-left">
            ...
            <div className="ml-2 lg:w-20 flex flex-col justify-center">
