...
function Footer() {
  return (
    <footer className="bg-secondary flex flex-col items-center justify-center py-6">
      <div className="md:w-4/5 w-7/8 flex  md:flex-row items-left justify-left md:gap-40 gap-3">
        <div className="w-2/5 md:w-1/3 flex flex-col items-left justify-left">
          <div className="flex items-center justify-left">
            <svg
              className="w-[33px] fill-current text-primary "
              version="1.0"
          ...
          <div className="flex flex-row pt-3 gap-4">
            <a
              href="https://www.linkedin.com/in/patrick-junior-bautista-toledo-3647521a4/"
              target="_blank"
              rel="noopener noreferrer"
              className=" hover:bg-sky-200 transition duration-300 rounded-md p-2"
            >
              <svg
            ...
            <a
              href="https://github.com/pbautistadev"
              target="_blank"
              rel="noopener noreferrer"
              className=" hover:bg-sky-200 transition duration-300 rounded-md p-2"
            >
              <svg
                ...
                viewBox="0 0 300 300"
              >
                <path d="M130.5 6.1c-25.2 3-49.9 12.8-69.6 27.6-28.2 21.2-46.4 51.1-53.6 87.8-2.4 12.4-2.4 39.6 0 52 4 20.5 12.2 41 22.4 56.3 6.9 10.2 16.3 21.3 17.4 20.6.5-.3.8 0 .7.7-.4 1.5 13.4 13.5 22.5 19.6 9.1 6 22.1 12.6 30.3 15.3 5.6 1.9 6.7 2 9.1.8 1.6-.8 2.7-2.1 2.7-3.1-.1-.9.2-1.7.7-1.7.5 0 .9-8.2.9-18.3v-18.3l-7.7.7c-8.2.8-19.4-.2-25.3-2.2-8.8-3.1-13.1-7.4-17.6-17.5-3.5-8-8.8-15.2-14.7-19.9-2.8-2.2-5.5-4.8-6.1-5.7-2.8-4.5 6.3-5.7 14.9-1.9 5.8 2.5 11.6 7.8 15 13.8 2.8 4.6 11.3 12.5 12.9 12 .6-.2 1.6.2 2.3.9 1.9 1.9 10.2 2.6 15.8 1.4 9.2-1.9 10.2-2.7 11.5-8 .6-2.7 2.5-6.9 4.1-9.5 3.3-5.2 3.4-5-5.9-6-23.9-2.4-41.2-12.3-48.7-28-4-8.2-5.3-13.7-6.5-25.9-1.7-17.1 1.2-29.2 9.4-39.9 3.5-4.6 3.6-4.9 2.5-9-3-10.6-.2-33.4 4.3-35.8 4.2-2.3 20.4 3.7 34.2 12.5 4.7 3 5.9 3.4 8.3 2.6 14.9-5.1 52.7-5 67.6 0 2.4.8 3.5.5 7-1.9 11.2-7.7 30.1-15.1 34.8-13.6 2.5.8 3.7 3.8 5.6 14 1.4 8 1.2 15.2-.8 22.7-.9 3.5-.7 4.1 3.1 9 8.8 11.1 11.8 21.4 10.6 36.9-2.7 35.7-18 51-56.4 56.3-4.5.6-8.1 1.5-8 2.1.2.5.7.9 1.1.7.5-.1.6.2.3.7-.4.5.3 2.5 1.3 4.3 3.7 6.2 4.4 13.1 4.5 43.6.1 27.8.2 29.4 2 30.8 3 2.1 7.8 1.7 15.8-1.5 23.8-9.4 46.8-27.7 62-49.1 29.9-42.1 35.9-97.5 15.8-144.2-4.7-10.9-12.8-24.1-14.2-23.2-.7.4-.8.2-.4-.5 2.3-3.6-23.1-28.5-40-39.3-13.1-8.4-33.7-16.4-51.2-19.9-11.5-2.3-35.2-3.2-46.7-1.8z" />
                <path d="M56 203c0 .5.7 1 1.6 1 .8 0 1.2-.5.9-1-.3-.6-1-1-1.6-1-.5 0-.9.4-.9 1zM62 208.4c0 .9.7 1.6 1.6 1.6.9 0 1.4-.5 1.2-1.2-.6-1.8-2.8-2.1-2.8-.4zM68 216.9c1.3 2.5 3.3 2.8 2.8.4-.2-1-1.1-1.9-2.1-2.1-1.6-.3-1.7-.1-.7 1.7zM74.2 224.2c.6 1.6 3.6 3.4 4.4 2.5.9-.9-1.5-3.7-3.3-3.7-.8 0-1.3.5-1.1 1.2zM84.5 230.1c-.8 1.2 1.1 2.9 3.3 2.9 1.9 0 1-3.4-1-3.8-.9-.2-1.9.2-2.3.9zM107.7 230.6c-1 1.1.3 2.4 2.4 2.4 1 0 1.9-.7 1.9-1.5 0-1.5-3.1-2.1-4.3-.9zM96.4 232.1c-.3.6 0 1.5.7 2 .8.5 1.5.4 1.7-.1.2-.6.8-.8 1.3-.4.5.3.9-.2.9-1 0-1.8-3.5-2.2-4.6-.5z" />
              </svg>
            </a>
          </div>
        </div>
        <div className="w-1/5md:w-1/3 flex flex-col items-left justify-left gap-4">
        ...
        <div className="w-2/5 md:w-1/3 flex flex-col items-left justify-left gap-4 ">
          <h1 className="t-[18px] font-bold text-white">Contacto</h1>
          {footerContactLinks.map((link) => (
            <div key={link.id} className="flex flex-row gap-2 wrap-anywhere">
              <svg
